...
static char *test_bed_file = "./tests/temp.bed";
static char *test_out_file = "./tests/out.fa";
...
static void test_fasta_extract(CuTest *testCase) {
    for(int64_t test=0; test<1000; test++) {
        ...
        st_logDebug("In faffy extract test have %" PRIi64 " sequences, %" PRIi64 " intervals and %" PRIi64 " marked bases\n",
