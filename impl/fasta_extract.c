...
static void report_interval(FILE *output, char *seq_name, int64_t start, int64_t end, stHash *sequences, stHash *sequenceLengths) {
...
static void interval_destruct(Interval *i) {
    free(i->name);
    free(i);
}

static int interval_cmp(Interval *i, Interval *j) {
